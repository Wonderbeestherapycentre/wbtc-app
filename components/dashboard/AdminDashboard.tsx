...
import { startOfWeek, endOfWeek, startOfMonth, endOfMonth, startOfYear, endOfYear, subMonths, startOfDay, endOfDay } from "date-fns";
...
export default async function AdminDashboard({ searchParams }: { searchParams: any }) {
    ...
    return (
        <AppLayout categories={categories} familyChildren={children} role="ADMIN">
